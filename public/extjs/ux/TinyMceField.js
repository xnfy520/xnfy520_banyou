    ...
    afterRender: function() {
        ...
        var editor = tinymce.createEditor(id,
            Ext.apply({
                ...
                toolbar1:"fontselect | fontsizeselect | link unlink anchor | image media responsivefilemanager | table charmap hr pagebreak nonbreaking | inserttime | visualblocks code preview fullscreen",
