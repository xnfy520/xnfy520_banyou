...
SWFUpload.prototype.getFlashHTML = function (flashVersion) {
	...
	return ['<object style="position: relative;top:5px" id="', this.movieName, '" type="application/x-shockwave-flash" data="', (this.support.imageResize ? this.settings.flash_url : this.settings.flash9_url), '" width="', this.settings.button_width, '" height="', this.settings.button_height, '" class="swfupload">',
