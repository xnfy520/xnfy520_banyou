...
<div class="uploader">
	...
	<div class="tabbable upload-tabbable"> <!-- Only required for left/right tabs -->
		...
		<div class="tab-pane active" id="tab1">
		    <?php } ?>
		<form action="dialog.php" style="min-height:330px" method="post" enctype="multipart/form-data" id="myAwesomeDropzone" class="dropzone">
		    ...
		    <div class="upload-help" style="text-align:center;padding:10px 5px"><?php echo lang_Upload_base_help; ?></div>
		<?php if($java_upload){ ?>
		</div>
