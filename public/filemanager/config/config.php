...
$current_path = '../../upload/source/'; // relative path fm filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../../upload/source_thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
...
*******************/
$aviary_active=false;
$aviary_key="ccd2y98moe2ftts2";
$aviary_secret="h9p1isek5leusbr9";
$aviary_version=3;
$aviary_language='zh_HANS';
...
$relative_path_from_current_pos         = array('source_thumbs/','source_thumbs/'); //relative path of the image folder from the current position on upload folder
